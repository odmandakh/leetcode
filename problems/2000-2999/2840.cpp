...
class Solution {
 public:
  bool checkStrings(string s1, string s2) {
    // Create a 2x26 array to track character counts
    // Row 0: characters at even indices, Row 1: characters at odd indices
    // Each column represents a letter from 'a' to 'z'
